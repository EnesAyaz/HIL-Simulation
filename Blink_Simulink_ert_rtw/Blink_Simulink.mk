###########################################################################
## Makefile generated for Simulink model 'Blink_Simulink'. 
## 
## Makefile     : Blink_Simulink.mk
## Generated on : Sun Feb 18 21:41:29 2018
##  version:  
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Blink_Simulink.elf
...
PRODUCT_NAME              = Blink_Simulink
MAKEFILE                  = Blink_Simulink.mk
COMPUTER                  = PCWIN64
MATLAB_ROOT               = D:/MATLAB/R2017a
MATLAB_BIN                = D:/MATLAB/R2017a/bin
MATLAB_ARCH_BIN           = D:/MATLAB/R2017a/bin/win64
MASTER_ANCHOR_DIR         = 
START_DIR                 = C:/Users/enes_/Documents/HIL-Simulation
ARCH                      = win64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
...
MODELREF_LINK_RSPFILE_NAME = Blink_Simulink_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Blink_Simulink.elf
...
DEFINES_ = -DMODEL=Blink_Simulink -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DINTEGER_CODE=0 -DMT=0 -DCLASSIC_INTERFACE=0 -DALLOCATIONFCN=0 -DONESTEPFCN=1 -DTERMFCN=1 -DMULTI_INSTANCE_CODE=0 -DTID01EQ=0 -DEXIT_FAILURE=1 -DEXTMODE_DISABLEPRINTF -DEXTMODE_DISABLETESTING -DEXTMODE_DISABLE_ARGS_PROCESSING=1 -DSTACK_SIZE=64 -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DRT -DMW_TIMERID=5 -DMW_PRESCALAR=256 -DMW_TIMERCOUNT=59286 -DMW_SCHEDULERCOUNTER=1 -D_RTT_BAUDRATE_SERIAL0_=9600 -D_RTT_BAUDRATE_SERIAL1_=9600 -D_RTT_BAUDRATE_SERIAL2_=9600 -D_RTT_BAUDRATE_SERIAL3_=9600 -D_RTT_ANALOG_REF_=0
...
DEFINES_STANDARD = -DMODEL=Blink_Simulink -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO
...
%.o : $(START_DIR)/Blink_Simulink_ert_rtw/%.c
	$(CC) $(CFLAGS) -o $@ $<


%.o : $(START_DIR)/Blink_Simulink_ert_rtw/%.s
	$(AS) $(ASFLAGS)  $@ $<


%.o : $(START_DIR)/Blink_Simulink_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<
